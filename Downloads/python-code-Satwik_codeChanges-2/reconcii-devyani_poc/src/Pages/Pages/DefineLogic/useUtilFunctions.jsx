            ...
            <div className="ddSelection">
              ...
              <div style={{ width: "100%", maxWidth: "400px" }}>
                <Select
                  ...
                  isSearchable={true}
                  placeholder="Select Dataset/Formula..."
                  onChange={(e) => {
                    onSelectFieldValue(
                      e.dataset_name,
                      logicItem,
                  ...
                  getOptionLabel={(option) => {
                    if (option.dataset_name) return option.dataset_name;
                    if (option.logicName) return option.logicName;
                ...
                checkOpts(fieldItem?.selectedFieldValue) ? (
                  <div style={{ width: "100%" }}>
                    <Select
                      ...
                      getOptionLabel={(option) => {
                        if (option.excelColumnName) return option.excelColumnName;
